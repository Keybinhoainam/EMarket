    ...
    <div >
        <v-app-bar :clipped-left="lgAndUp" app color="primary" dark v-if="role=='customer'" >
            ...
            <v-toolbar-title style="width: 350px">
                <a @click="$router.push('/')" class="text-white" style="text-decoration: none"
            ...
            <Notification />
            <v-btn @click="$router.push('/cart')" icon title="Cart">
            ...
            <v-btn @click="$router.push('/wishlist')" icon title="Wishlist">
