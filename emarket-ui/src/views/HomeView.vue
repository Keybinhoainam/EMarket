<template>
  <div id="home">
    ...
    <!-- <div id="background-div" class="page-holder bg-cover">
      ...
      <div class="container py-5">
        <header class="text-left text-white py-5">
          ...
          <p id="content" class="lead mb-0 bg-dark p-1 rounded"></p>
        </header>
      </div>
    </div> -->
    ...
    <div id="start-shopping" class="container">
      ...
      <div class="row">
        <div v-for="category of categories" :key="category" class="col-md-6 col-xl-4 col-12 pt-3  justify-content-around d-flex">
    ...
    <div class="container">
      ...
      <div class="row">
        <div v-for="product of products" :key="product" class="col-md-6 col-xl-4 col-12 pt-3  justify-content-around d-flex">
