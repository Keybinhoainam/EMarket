...
export default {
  ...
  methods: {
    ...
    saveProduct() {
      ...
      productService
        .saveProduct(this.saveProductUrl, this.product, this.config)
        .then(
          (res) => {
          ...
          (err) => {
            this.alertFail("Failed to create/update an product !", err.message);
          }
        );
    },
    saveProductImage() {
      ...
      productService
        .saveProductImages(this.saveProductImagesUrl, formData, this.config)
        .then(
          () => {},
          (err) => {
            this.alertFail("Failed to upload product images !", err.message);
            return;
          }
        );
